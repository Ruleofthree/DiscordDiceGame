...
class PTwoXP(commands.Cog):
    def __init__(self, client):
        self.client = client

    def playertwo_currentHP_less_zero(self, msg, pTwoInfo, pOneInfo, playerTwo, playerOne, pOneCurrentHP, pTwoCurrentHP,
        ...
        msg.append(pTwoInfo['name'] + " has earned: [color=red]"
                   + str(xp) + "[/color] experience points.\n " +
                   pOneInfo['name'] + " has earned: [color=red]"
                   + str(int(xp / 2)) + "[/color]")
